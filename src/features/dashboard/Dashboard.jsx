    ...
    <div className="max-w-[1400px] mx-auto my-8">
      <div className="bg-white rounded-lg p-8 mb-6 shadow-md hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300 animate-[fadeIn_0.5s_ease-in]">
        ...
        <p className="text-[#8b95a5] text-base mt-2">
          Ready to build your wealth and slash your taxes?
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-[fadeIn_0.5s_ease-in]">
        <div className="bg-white rounded-lg p-8 mb-6 shadow-md hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300">
          ...
          <div className="mt-6 text-[#2c3e50]">
            <p>
              <strong>1 of 8</strong> courses completed
            </p>
            <p>
              <strong>1 of 8</strong> quizzes passed (70% required)
            </p>
            <p>
              <strong>2 of 8</strong> strategies in progress
            </p>
          </div>
          <p className="mt-6 text-[0.9rem] text-[#666]">
            <em>
              📊 Your courses are generated from your personalized tax plan
            </em>
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg p-8 mb-6 shadow-md hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300">
          ...
          <p className="text-center text-[#2c3e50]">
            <strong>Projected Year 1 Savings</strong>
          </p>
          <p className="text-center text-[#8b95a5] text-[0.9rem]">
            Based on strategies in your tax plan
          </p>
          <div className="mt-6 p-4 bg-[#e8eaed] rounded-lg text-center">
            <p className="m-0 text-[#2c3e50]">
              <strong>Implementation Status:</strong>
            </p>
            <p className="mt-2 mb-0 text-[0.9rem] text-[#2c3e50]">
              2 strategies active • 6 pending completion
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg p-8 mb-6 shadow-md hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300 mt-8 animate-[fadeIn_0.5s_ease-in]">
        <div className="border-b-2 border-[#e8eaed] pb-4 mb-6">
          <h2 className="text-[#1a2332] text-[1.75rem] font-semibold">
            📚 Continue Learning: Entity Structuring & S-Corp Benefits
          </h2>
          <p className="text-[#8b95a5] text-base mt-2">
        ...
        <div className="py-4 px-6 rounded-md mb-6 border-0 border-solid border-l-4 bg-[#d1ecf1] border-[#0c5460] text-[#0c5460]">
          <strong>🎯 Learning Goal:</strong> Master business entity structures
          and understand how S-Corp election can save you $15K-$40K annually in
        ...
        <div className="flex justify-center mt-8">
          <Link
            to="/week2-lesson"
            className="py-4 px-8 border-none rounded-md text-[1.1rem] font-semibold cursor-pointer transition-all duration-300 inline-block text-center bg-[#1a2332] text-white hover:bg-[#2d3e50] hover:-translate-y-0.5 hover:shadow-lg no-underline"
          >
            Start Entity Structuring Lesson →
          </Link>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8 animate-[fadeIn_0.5s_ease-in]">
        <div className="bg-white rounded-lg p-8 mb-6 shadow-md hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300 text-center">
          <div className="w-[60px] h-[60px] mx-auto mb-4 bg-gradient-to-br from-[#4a90e2] to-[#d4af37] rounded-full flex items-center justify-center text-[1.5rem] text-white">
            📹
          </div>
          ...
          <Link
            to="/curriculum"
            className="py-3 px-6 border-none rounded-md text-base font-semibold cursor-pointer transition-all duration-300 inline-block text-center mt-4 bg-[#c0c5ce] text-[#1a2332] hover:bg-[#8b95a5] no-underline"
          >
            View All
          </Link>
        </div>
        ...
        <div className="bg-white rounded-lg p-8 mb-6 shadow-md hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300 text-center">
          ...
          <Link
            to="/chat"
            className="py-3 px-6 border-none rounded-md text-base font-semibold cursor-pointer transition-all duration-300 inline-block text-center mt-4 bg-[#d4af37] text-[#1a2332] hover:bg-[#c49a2e] no-underline"
          >
            Start Chat
          </Link>
        </div>
      ...
      <div className="bg-white rounded-lg p-8 mb-6 shadow-md hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300 mt-8 animate-[fadeIn_0.5s_ease-in]">
        <h2 className="text-[#1a2332] text-[1.75rem] font-semibold">
          📅 Upcoming Live Sessions & Consultations
        </h2>
        <div className="mt-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div>
                <h4 className="text-[#1a2332] font-semibold">
                  Monthly "Architect's Q&A" with Norman Dotch
                </h4>
                <p className="mt-2 text-[#2c3e50]">
                  First Thursday of Month • 7:00 PM EST
                </p>
                <p className="text-[#8b95a5]">
                  Live session covering advanced strategies and student
                  questions
                </p>
              </div>
              <a
                href="#"
                className="py-3 px-6 border-none rounded-md text-base font-semibold cursor-pointer transition-all duration-300 inline-block text-center bg-[#1a2332] text-white hover:bg-[#2d3e50] hover:-translate-y-0.5 hover:shadow-lg no-underline whitespace-nowrap"
              >
                Add to Calendar
              </a>
            </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div>
                ...
                <p className="opacity-90">
                  Direct consultation to review your tax plan and implementation
                  progress
                </p>
              </div>
              <a
                href="#"
                className="py-3 px-6 border-none rounded-md text-base font-semibold cursor-pointer transition-all duration-300 inline-block text-center bg-white text-[#1a2332] hover:bg-[#e8eaed] no-underline whitespace-nowrap"
              >
                Schedule Now
              </a>
            </div>
          ...
          <div className="bg-[#e8eaed] rounded-lg p-8 shadow-md mt-4">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div>
                ...
                <p className="text-[#8b95a5]">
                  Hear from graduates who saved $100K+ in taxes
                </p>
              </div>
              <a
                href="#"
                className="py-3 px-6 border-none rounded-md text-base font-semibold cursor-pointer transition-all duration-300 inline-block text-center bg-[#c0c5ce] text-[#1a2332] hover:bg-[#8b95a5] no-underline whitespace-nowrap"
              >
                Register
              </a>
            </div>
      ...
      <div className="bg-white rounded-lg p-8 mb-6 shadow-md hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300 mt-8 animate-[fadeIn_0.5s_ease-in]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          <div>
            ...
            <p className="mt-4 text-[1.5rem] text-[#d4af37] font-bold">
              $50K - $100K/year
            </p>
          </div>
          <div>
            <h4 className="text-[#1a2332] font-semibold">
              10-Year Net Worth Target
            </h4>
            <p className="mt-4 text-[1.5rem] text-[#d4af37] font-bold">
              $5M - $10M
            </p>
        ...
        <Link
          to="/goal-setting"
          className="py-3 px-6 border-none rounded-md text-base font-semibold cursor-pointer transition-all duration-300 inline-block text-center mt-6 bg-[#c0c5ce] text-[#1a2332] hover:bg-[#8b95a5] no-underline"
        >
          Update Goals
        </Link>
      </div>
      ...
      <div className="bg-gradient-to-br from-[#4a90e2] to-[#d4af37] text-white rounded-lg p-8 mb-6 shadow-md hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300 mt-8 animate-[fadeIn_0.5s_ease-in]">
        ...
        <p className="text-[1.1rem] mt-4">
          "Great job completing onboarding! You're already ahead of 90% of
          dentists who never take action on their taxes. This week's R.O.B.S.
          strategy could save you tens of thousands if you're buying or
          expanding a practice. Let's dive in! 🚀"
        </p>
        <p className="mt-4">
