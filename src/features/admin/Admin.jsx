    ...
    <div className="max-w-[1400px] mx-auto my-8">
      ...
      <div className="bg-white rounded-lg p-8 mb-6 shadow-md transition-all duration-300 animate-[fadeIn_0.5s_ease-in]">
        <div className="bg-[#1a2332] p-4 my-4 rounded-lg flex flex-col sm:flex-row justify-center gap-4">
          <button
            className={`py-3 px-8 border-2 border-solid border-[#d4af37] cursor-pointer rounded-md font-semibold transition-all duration-300 ${
              activeRole === "admin"
                ? "bg-[#d4af37] text-[#1a2332]"
                : "bg-transparent text-white hover:bg-[#d4af37] hover:text-[#1a2332]"
            }`}
        ...
        <div className="animate-[fadeIn_0.5s_ease-in]">
          <div className="bg-white rounded-lg p-8 mb-6 shadow-md transition-all duration-300 animate-[fadeIn_0.5s_ease-in]">
            ...
            <p className="text-[#8b95a5] text-base mt-2">
              Complete System Overview & Management
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg p-8 mb-6 shadow-md transition-all duration-300 mt-8">
            ...
            <div className="bg-white rounded-lg overflow-hidden mt-6">
              <div className="flex flex-wrap border-b-2 border-[#e8eaed] bg-[#e8eaed]">
                <button
                  className={`flex-1 p-4 cursor-pointer font-semibold transition-all border-0 border-solid ${
                    activeUserTab === "users"
                      ? "bg-white text-[#1a2332] border-b-[3px] border-b-[#d4af37]"
                      : "bg-transparent text-[#8b95a5] hover:text-[#1a2332]"
                  }`}
              ...
              {activeUserTab === "users" && (
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
                    <button className="py-3 px-6 rounded-md font-semibold border-none bg-[#1a2332] text-white hover:bg-[#2d3e50] transition-all">
                      Add New User
                    </button>
                    <button className="py-3 px-6 rounded-md font-semibold border-none bg-[#c0c5ce] text-[#1a2332] hover:bg-[#8b95a5] transition-all">
                      Bulk Import Users
                    </button>
                    <button className="py-3 px-6 rounded-md font-semibold border-none bg-[#c0c5ce] text-[#1a2332] hover:bg-[#8b95a5] transition-all">
                      Export User Data
          ...
          <div className="bg-white rounded-lg p-8 mb-6 shadow-md transition-all duration-300 mt-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
              <div className="bg-[#e8eaed] p-6 rounded-lg">
                <h4 className="text-[#1a2332] font-semibold">
                ...
                <div className="bg-white border-0 border-solid border-l-4 border-[#4a90e2] p-4 mb-4 rounded shadow-sm mt-4">
                  <strong className="text-[#1a2332]">Dr. Sarah Chen</strong> -
                  Week 12 Complete
                  <div className="mt-4 flex flex-wrap gap-2">
                    <button className="py-2 px-4 rounded-md text-[0.875rem] font-semibold border-none bg-[#1a2332] text-white hover:bg-[#2d3e50] transition-all">
                      Review & Approve
                    </button>
                    <button className="py-2 px-4 rounded-md text-[0.875rem] font-semibold border-none bg-[#c0c5ce] text-[#1a2332] hover:bg-[#8b95a5] transition-all">
                      View Details
                    </button>
                  </div>
                </div>
              ...
              <div className="bg-[#e8eaed] p-6 rounded-lg">
                ...
                <button className="py-3 px-6 rounded-md font-semibold border-none bg-[#c0c5ce] text-[#1a2332] hover:bg-[#8b95a5] transition-all mt-6">
          ...
          <div className="bg-white rounded-lg p-8 mb-6 shadow-md transition-all duration-300 mt-8">
            <h2 className="text-[#1a2332] text-[1.75rem] font-semibold">
              ✅ Compliance Checks & System Monitoring
            </h2>
            ...
            <div className="p-4 my-2 rounded-md border-0 border-solid border-l-4 bg-[#fff3e0] border-[#ffc107]">
              ...
              <br />3 students have incomplete mandatory assessments - automated
              reminders sent
            </div>
            <div className="p-4 my-2 rounded-md border-0 border-solid border-l-4 bg-[#e8f5e9] border-[#28a745]">
              ...
              <table className="w-full border-collapse bg-white">
                ...
                <tbody>
                  <tr className="border-b border-[#e8eaed] hover:bg-[#e8eaed]">
                    <td className="p-4">
                      <strong>Entity Structuring & S-Corp Benefits</strong>
                    </td>
                    <td className="p-4">
                      <span className="inline-block py-1 px-3 rounded-full text-[0.85rem] font-semibold bg-[#28a745] text-white">
                        Active
                      </span>
                    </td>
                  ...
                  <tr className="border-b border-[#e8eaed] hover:bg-[#e8eaed]">
                    <td className="p-4">
                      <strong>IRC §7702 - Private Banking Strategy</strong>
                    </td>
                    <td className="p-4">
                      <span className="inline-block py-1 px-3 rounded-full text-[0.85rem] font-semibold bg-[#28a745] text-white">
                        Active
                  ...
                  <tr className="border-b border-[#e8eaed] hover:bg-[#e8eaed]">
                    <td className="p-4">
                      <strong>Estate Planning & Wealth Transfer</strong>
                    </td>
                    <td className="p-4">
                      <span className="inline-block py-1 px-3 rounded-full text-[0.85rem] font-semibold bg-[#28a745] text-white">
                        Active
          ...
          <div className="bg-white rounded-lg p-8 mb-6 shadow-md transition-all duration-300 mt-8">
            ...
            <p className="text-[#8b95a5] text-base mt-2">
              Manage course content, upload video lessons, and organize weekly
              curriculum
            </p>
            <div className="py-4 px-6 rounded-md mb-6 border-0 border-solid border-l-4 bg-[#d1ecf1] border-[#0c5460] text-[#0c5460] mt-6">
              <strong>📊 Content Status:</strong> 11 active courses • 8 video
              lessons uploaded • 4 pending review
            </div>
            ...
            {activeCurriculumTab === "courses" && (
              <div className="mt-6">
                <div className="mt-6 flex flex-wrap gap-2">
                  <button
                    className="py-3 px-6 rounded-md font-semibold border-none bg-[#1a2332] text-white hover:bg-[#2d3e50] transition-all"
                  ...
                  <table className="w-full border-collapse bg-white">
                    ...
                    <tbody>
                      <tr className="border-b border-[#e8eaed] hover:bg-[#e8eaed]">
                        ...
                        <td className="p-4">
                          <span className="inline-block py-1 px-3 rounded-xl text-[0.85rem] font-semibold bg-[#4a90e2] text-white">
                            Pillar 1
                          </span>
                        </td>
                        <td className="p-4">
                      ...
                      <tr className="border-b border-[#e8eaed] hover:bg-[#e8eaed]">
                        ...
                        <td className="p-4">
                          <span className="inline-block py-1 px-3 rounded-xl text-[0.85rem] font-semibold bg-[#d4af37] text-white">
                            Pillar 2
                          </span>
                        </td>
                        <td className="p-4">
                      ...
                      <tr className="border-b border-[#e8eaed] hover:bg-[#e8eaed]">
                        <td className="p-4">
                          <strong>
                            EXIT & SALE OF PRACTICE - The R.O.B.S. Roth 401(k)
                            Strategy
                          </strong>
                        </td>
                        <td className="p-4">
                          <span className="inline-block py-1 px-3 rounded-xl text-[0.85rem] font-semibold bg-[#764ba2] text-white">
                            Pillar 4
                          </span>
                        </td>
                        <td className="p-4">
            ...
            {activeCurriculumTab === "videos" && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                ...
                <div className="bg-[#e8eaed] rounded-lg p-8 shadow-md">
                  <h3 className="text-[#1a2332] font-semibold">
                  ...
                  <form className="mt-6">
                    ...
                    <div className="mb-6">
                      ...
                      <input
                        type="file"
                        className="w-full py-3 px-4 border-2 border-[#e8eaed] rounded-md text-base bg-white"
                        accept="video/*"
                      />
                      <small className="text-[#8b95a5]">
                    ...
                    <div className="mb-6">
                      ...
                      />
                      <small className="text-[#8b95a5]">
                        Use Vimeo, YouTube, or direct video URL
                      </small>
                    </div>
                    <div className="mb-6">
                      <label className="block mb-2 text-[#1a2332] font-semibold">
                    ...
                    <div className="mb-6">
                      ...
                      <textarea
                        className="w-full py-3 px-4 border-2 border-[#e8eaed] rounded-md text-base bg-white min-h-[100px] resize-y"
                        rows="3"
                    ...
                    <div className="flex flex-wrap gap-4 mt-6">
                      ...
                      <button
                        type="button"
                        className="py-3 px-6 rounded-md font-semibold border-none bg-[#c0c5ce] text-[#1a2332] hover:bg-[#8b95a5] transition-all"
                      >
                        Save as Draft
                      </button>
                    </div>
                  ...
                  <div className="mt-6">
                    <div className="bg-white border-0 border-solid border-l-4 border-[#4a90e2] p-4 mb-4 rounded shadow-sm">
                      <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                        <div>
                          <strong className="text-[#1a2332]">
                            Entity Structuring - Main Lesson
                          </strong>
                          <p className="mt-2 text-[0.9rem] text-[#8b95a5]">
                            Duration: 42:15 • Uploaded: Jan 15, 2025
                            <br />
                    ...
                    <div className="bg-white border-0 border-solid border-l-4 border-[#4a90e2] p-4 mb-4 rounded shadow-sm">
                      <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                        <div>
                          ...
                          <p className="mt-2 text-[0.9rem] text-[#8b95a5]">
                            Duration: 38:20 • Uploaded: Jan 12, 2025
                            <br />
                    ...
                    <div className="bg-white border-0 border-solid border-l-4 border-[#4a90e2] p-4 mb-4 rounded shadow-sm">
                      <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                        <div>
                          <strong className="text-[#1a2332]">
                            Private Banking Strategy - Case Study
                          </strong>
                          <p className="mt-2 text-[0.9rem] text-[#8b95a5]">
                            Duration: 28:45 • Uploaded: Jan 10, 2025
                            <br />
                    ...
                    <button className="w-full py-3 px-6 rounded-md font-semibold border-none bg-[#c0c5ce] text-[#1a2332] hover:bg-[#8b95a5] transition-all mt-4">
                      View All Videos (24)
                    </button>
                  </div>
                </div>
              ...
              <div className="mt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-6">
                  <div className="bg-[#e8eaed] rounded-lg p-8 shadow-md">
                    ...
                    <p className="mt-4">
                      <strong>R.O.B.S. Strategy</strong>
                    </p>
                  ...
                  <div className="bg-[#e8eaed] rounded-lg p-8 shadow-md">
                    ...
                    <p className="mt-4">
                      <strong>
                        EXIT & SALE OF PRACTICE - R.O.B.S. Roth 401(k)
                      </strong>
                    </p>
                    <p className="text-[0.9rem] text-[#8b95a5]">
                      📹 Video: ⏳ Pending
              ...
              <div className="mt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-6">
                  <div className="bg-gradient-to-br from-[#4a90e2] to-[#357ABD] text-white rounded-lg p-8 shadow-md">
                    ...
                    <p className="mt-4">
                      2 active courses • 147 enrolled students
                    </p>
                    <p className="text-[0.9rem] opacity-90 mt-2">
                      • Entity Structuring & S-Corp Benefits
                      <br />• Asset Protection Strategies
                    </p>
                    <div className="flex flex-wrap gap-4 mt-4">
                      <button className="py-2 px-4 rounded-md text-[0.875rem] font-semibold border-none bg-white text-[#1a2332] hover:bg-[#e8eaed] transition-all">
                        Edit Pillar
                      </button>
                      <button className="py-2 px-4 rounded-md text-[0.875rem] font-semibold bg-transparent border border-solid border-white text-white hover:bg-white/10 transition-all">
                        Manage Courses
                      </button>
                    </div>
                  </div>
                  <div className="bg-gradient-to-br from-[#d4af37] to-[#C49A2E] text-white rounded-lg p-8 shadow-md">
                    ...
                    <p className="mt-4">
                      3 active courses • 234 enrolled students
                    </p>
                    <p className="text-[0.9rem] opacity-90 mt-2">
                      • IRC §469 - Passive Loss Planning
                      <br />
                      • IRC §7702 - Private Banking Strategy
                      <br />• Augusta Rule (IRC §280A)
                    </p>
                    <div className="flex flex-wrap gap-4 mt-4">
                      <button className="py-2 px-4 rounded-md text-[0.875rem] font-semibold border-none bg-white text-[#1a2332] hover:bg-[#e8eaed] transition-all">
                        Edit Pillar
                  ...
                  <div className="bg-gradient-to-br from-[#2ECC71] to-[#27AE60] text-white rounded-lg p-8 shadow-md">
                    ...
                    <p className="mt-4">
                      2 active courses • 189 enrolled students
                    </p>
                    <p className="text-[0.9rem] opacity-90 mt-2">
                      • Defined Benefit & Cash Balance Plans
                      <br />• IRC §1031 Exchanges
                    </p>
                    <div className="flex flex-wrap gap-4 mt-4">
                      <button className="py-2 px-4 rounded-md text-[0.875rem] font-semibold border-none bg-white text-[#1a2332] hover:bg-[#e8eaed] transition-all">
                        Edit Pillar
                  ...
                  <div className="bg-gradient-to-br from-[#764ba2] to-[#667eea] text-white rounded-lg p-8 shadow-md">
                    ...
                    <p className="mt-4">
                      4 active courses • 156 enrolled students
                    </p>
                    <p className="text-[0.9rem] opacity-90 mt-2">
                      • Captive Insurance (IRC §831(b))
                      <br />
                      ...
                      <br />
                      • EXIT & SALE OF PRACTICE
                      <br />• Tax Plan Integration & Implementation
                    </p>
                    <div className="flex flex-wrap gap-4 mt-4">
                      <button className="py-2 px-4 rounded-md text-[0.875rem] font-semibold border-none bg-white text-[#1a2332] hover:bg-[#e8eaed] transition-all">
                        Edit Pillar
      ...
      {activeRole === "instructor" && (
        <div className="animate-[fadeIn_0.5s_ease-in]">
          <div className="bg-white rounded-lg p-8 mb-6 shadow-md transition-all duration-300 animate-[fadeIn_0.5s_ease-in]">
            ...
            <p className="text-[#8b95a5] text-base mt-2">
              Student Mentoring & Progress Management
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg p-8 mb-6 shadow-md transition-all duration-300 mt-8">
            ...
            <div className="bg-white border-0 border-solid border-l-4 border-[#4a90e2] p-4 mb-4 rounded shadow-sm mt-6">
              <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                <div>
                  <h4 className="m-0 text-[#1a2332] font-semibold">
                    Dr. James Williams
                  </h4>
                  <p className="my-2 text-[#8b95a5]">
                    Week 3 - No activity in 3 days
                  </p>
                  <span className="inline-block py-1 px-3 rounded-xl text-[0.85rem] font-semibold bg-[#dc3545] text-white">
                    Needs Attention
                  </span>
              ...
              <div className="mt-4">
                ...
                <p className="mt-2 text-[0.9rem] text-[#2c3e50]">
                  Last quiz score: 76% | 2 modules incomplete
                </p>
              </div>
            </div>
            <div className="bg-white border-0 border-solid border-l-4 border-[#4a90e2] p-4 mb-4 rounded shadow-sm">
              ...
              <div className="mt-4">
                ...
                <p className="mt-2 text-[0.9rem] text-[#2c3e50]">
                  Last quiz score: 88% | Has questions pending
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-8 mb-6 shadow-md transition-all duration-300 mt-8">
            ...
            <div className="bg-white border-0 border-solid border-l-4 border-[#4a90e2] p-4 mb-4 rounded shadow-sm mt-6">
              <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                <div className="flex-1">
                  ...
                  (Week 5)
                  <p className="my-2 text-[#2c3e50]">
                    "Can you explain the difference between §7702 and §831(b)
            ...
            <div className="bg-white border-0 border-solid border-l-4 border-[#4a90e2] p-4 mb-4 rounded shadow-sm">
              <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                <div className="flex-1">
                  <strong className="text-[#1a2332]">Dr. Lisa Martinez</strong>{" "}
                  (Week 8)
                  <p className="my-2 text-[#2c3e50]">
                    "What's the typical timeline for completing a cost
                    segregation study?"
                  </p>
                  <span className="inline-block py-1 px-3 rounded-xl text-[0.85rem] font-semibold bg-[#4a90e2] text-white">
                    5 hours ago
            ...
            <div className="bg-white border-0 border-solid border-l-4 border-[#4a90e2] p-4 mb-4 rounded shadow-sm">
              <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                <div className="flex-1">
                  ...
                  (Week 10)
                  <p className="my-2 text-[#2c3e50]">
                    "Need guidance on structuring my first 1031 exchange for
          ...
          <div className="bg-white rounded-lg p-8 mb-6 shadow-md transition-all duration-300 mt-8">
            ...
            <div className="bg-[#e8eaed] p-6 rounded-lg mt-6">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                  <h4 className="m-0 text-[#1a2332] font-semibold">
                    Monthly "Architect's Q&A" Session
                  </h4>
                  <p className="my-2 text-[#2c3e50]">
                    First Thursday of Month, 7:00 PM EST
                  </p>
                  <span className="inline-block py-1 px-3 rounded-xl text-[0.85rem] font-semibold bg-[#28a745] text-white">
            ...
            <div className="bg-[#e8eaed] p-6 rounded-lg mt-4">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                  <h4 className="m-0 text-[#1a2332] font-semibold">
                    Advanced Tax Strategies Workshop
                  </h4>
          ...
          <div className="bg-white rounded-lg p-8 mb-6 shadow-md transition-all duration-300 mt-8">
            ...
            <div className="bg-[#e8eaed] p-6 rounded-lg mt-6">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                  <h4 className="m-0 text-[#1a2332] font-semibold">
                    Scheduled Q1 2025 Consultations
                  </h4>
                  <p className="my-2 text-[#2c3e50]">
                    Direct one-on-one strategy review sessions
                  </p>
                  <span className="inline-block py-1 px-3 rounded-xl text-[0.85rem] font-semibold bg-[#4a90e2] text-white">
                    34 consultations scheduled
                  </span>
                </div>
                <button className="py-3 px-6 rounded-md font-semibold border-none bg-[#1a2332] text-white hover:bg-[#2d3e50] transition-all">
                  View Schedule
            ...
            <div className="bg-[#e8eaed] p-6 rounded-lg mt-4">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                  ...
                  <p className="my-2 text-[#2c3e50]">
                    Students requesting quarterly review
                  </p>
                  <span className="inline-block py-1 px-3 rounded-xl text-[0.85rem] font-semibold bg-[#ffc107] text-[#1a2332]">
                    12 pending requests
                  </span>
            ...
            <div className="bg-white border-0 border-solid border-l-4 border-[#4a90e2] p-4 mb-4 rounded shadow-sm mt-6">
              <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                <div>
                  ...
                  <p className="my-2 text-[#2c3e50]">
                    Completed all 12 weeks | Quiz average: 92%
                  </p>
                  <p className="my-2 text-[0.9rem] text-[#8b95a5]">
                    ✓ All modules complete | ✓ Final assessment passed | ✓
                    Implementation case study submitted
                  </p>
                </div>
                <button className="py-2 px-4 rounded-md text-[0.875rem] font-semibold border-none bg-[#1a2332] text-white hover:bg-[#2d3e50] transition-all">
                  Review & Certify
            ...
            <div className="bg-white border-0 border-solid border-l-4 border-[#4a90e2] p-4 mb-4 rounded shadow-sm">
              <div className="flex flex-col md:flex-row justify-between items-start gap-4">
                <div>
                  ...
                  <p className="my-2 text-[#2c3e50]">
                    Completed all 12 weeks | Quiz average: 91%
                  </p>
                  <p className="my-2 text-[0.9rem] text-[#8b95a5]">
                    ✓ All modules complete | ✓ Final assessment passed | ✓
                    Implementation case study submitted
          ...
          <div className="bg-white rounded-lg p-8 mb-6 shadow-md transition-all duration-300 mt-8">
            ...
            <ul className="list-none p-0 mt-6">
              <li className="py-3 pl-6 relative border-b border-[#e8eaed] before:content-['✓'] before:absolute before:left-0 before:text-[#28a745] before:font-bold">
                <strong>Dr. Sarah Chen</strong> - Achieved $127K in annual tax
                savings through Defined Benefit Plan implementation
              </li>
              <li className="py-3 pl-6 relative border-b border-[#e8eaed] before:content-['✓'] before:absolute before:left-0 before:text-[#28a745] before:font-bold">
                <strong>Dr. James Williams</strong> - Successfully structured
                §831(b) captive insurance for asset protection
              </li>
              <li className="py-3 pl-6 relative border-b border-[#e8eaed] before:content-['✓'] before:absolute before:left-0 before:text-[#28a745] before:font-bold">
                <strong>Dr. Emily Rodriguez</strong> - Completed first 1031
                exchange, deferring $85K in capital gains
              </li>
              <li className="py-3 pl-6 relative border-b-0 before:content-['✓'] before:absolute before:left-0 before:text-[#28a745] before:font-bold">
                <strong>Dr. Michael Thompson</strong> - Implemented cost
                segregation study, accelerating $340K in depreciation
              </li>
            </ul>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
              <button className="py-3 px-6 rounded-md font-semibold border-none bg-[#1a2332] text-white hover:bg-[#2d3e50] transition-all">
      ...
      {showAddCourseModal && (
        <div
          className="fixed z-[10000] left-0 top-0 w-full h-full overflow-auto bg-black/60 flex items-start justify-center p-8"
          onClick={() => setShowAddCourseModal(false)}
        >
          <div
            className="bg-white rounded-lg w-full max-w-[700px] shadow-xl max-h-[90vh] overflow-y-auto animate-[slideDown_0.3s_ease]"
          ...
          >
            <div className="flex justify-between items-center py-6 px-8 border-b-2 border-[#e8eaed] bg-gradient-to-br from-[#1a2332] to-[#2d3e50] text-white rounded-t-lg">
              <h2 className="m-0 text-[1.5rem] font-semibold">
                ➕ Add New Course
              </h2>
              <button
                className="text-white text-[2rem] font-bold cursor-pointer leading-none bg-transparent border-none hover:text-[#d4af37] hover:scale-110 transition-all"
                onClick={() => setShowAddCourseModal(false)}
              >
                &times;
              </button>
            ...
            <form onSubmit={handleAddCourse}>
              <div className="p-8">
                <div className="mb-6">
                  ...
                  <input
                    type="text"
                    className="w-full py-3 px-4 border-2 border-[#e8eaed] rounded-md text-base focus:outline-none focus:border-[#4a90e2] transition-colors"
                ...
                <div className="mb-6">
                  ...
                  <textarea
                    className="w-full py-3 px-4 border-2 border-[#e8eaed] rounded-md text-base min-h-[100px] resize-y focus:outline-none focus:border-[#4a90e2] transition-colors"
                    rows="4"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="mb-6">
                    ...
                    <input
                      type="text"
                      className="w-full py-3 px-4 border-2 border-[#e8eaed] rounded-md text-base focus:outline-none focus:border-[#4a90e2] transition-colors"
                      placeholder="e.g., $30K-$100K annually"
                    />
                  </div>
                  <div className="mb-6">
                    <label className="block mb-2 text-[#1a2332] font-semibold">
              ...
              <div className="py-4 px-8 border-t-2 border-[#e8eaed] flex flex-col sm:flex-row justify-end gap-4 bg-[#e8eaed] rounded-b-lg">
                <button
                  type="button"
                  className="py-3 px-6 rounded-md font-semibold bg-[#c0c5ce] text-[#1a2332] hover:bg-[#8b95a5] transition-all"
                  onClick={() => setShowAddCourseModal(false)}
                >
                  Cancel
                </button>
